<template>
    <recycle-list class="list" for="(item,index) in longList" switch="type">
        <cell-slot case="tab" class="tab-cell row">
        ...
        <cell-slot case="banner" class="banner-cell">
            <img class="banner-image" :src="item.src"/>
        </cell-slot>

        <cell-slot case="apps" class="app-cell row">
        ...
        <cell-slot case="card" class="card-cell">
            <div class="card">
                <div style="height: 60px;padding-left: 30px">
                    <img class="card-banner" src="//img.alicdn.com/tfs/TB1moeURFXXXXasXXXXXXXXXXXX-390-105.png">
                </div>
                <div class="row" style="padding-bottom: 18px">
                    <div class="card-side">
                        <img class="card-poster" :src="item.poster">
                    </div>
